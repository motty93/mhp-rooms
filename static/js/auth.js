...
function updateAuthUI() {
	...
	const createRoomEmptyUnauth = document.getElementById(
		"create-room-empty-unauth",
	);
	...
	if (isAuthenticated) {
		...
		if (createRoomEmptyUnauth)
			createRoomEmptyUnauth.style.display = "inline-block";
	}
}
...
document.addEventListener("DOMContentLoaded", () => {
	...
	if (createRoomEmptyUnauth) {
		createRoomEmptyUnauth.addEventListener(
			"click",
			handleUnauthenticatedCreateRoom,
		);
	}
});
